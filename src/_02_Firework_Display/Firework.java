...
public class Firework{
    ...
    public Firework() {
    	...
    	for(int i = 0; i<sparks.length; i++) {
    		sparks[i] = new Spark(Toolkit.getDefaultToolkit().getScreenSize().width/2, Toolkit.getDefaultToolkit().getScreenSize().height - 100);
    	}
    }
    ...
    public void launch() {
    	...
    	for(int i = 0; i<sparks.length; i++) {
    		...
    		sparks[i].y = Toolkit.getDefaultToolkit().getScreenSize().height - 100;
    	}
