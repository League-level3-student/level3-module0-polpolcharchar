...
public class _03_FindTheHiddenButton implements ActionListener{
    ...
    public void start() {
        ...
        button = new JButton[Integer.parseInt(JOptionPane.showInputDialog("Enter a number"))];
        ...
        System.out.println("There is a special button in all of these buttons, find it!");
        // 13. initialize the hiddenButton variable to a random number less than
        //     the int created in step 3
        Random r = new Random();
        
        hiddenButton = r.nextInt(button.length-1);
